...
payload = {"text": "testing.. is this thing on?"}
...
print("Got OAuth Secret: %s" % resource_owner_secret)
...
print("Got User token: %s" % access_token)
print("Got User Secret: %s" % access_token_secret)
